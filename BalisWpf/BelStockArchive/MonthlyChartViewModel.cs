...
namespace BalisWpf
{
    ...
    {
        private ObservableCollection<BelStockArchiveLine> _rates { get; set; } = new ObservableCollection<BelStockArchiveLine>();
