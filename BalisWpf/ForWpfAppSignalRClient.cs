...
namespace BalisWpf
{
    public class ForWpfAppSignalRClient : INotifyPropertyChanged
    {
        ...
        public ForWpfAppSignalRClient(IniFile iniFile, IMyLog logFile)
        {
            _iniFile = iniFile;
            _logFile = logFile;
        }
        ...
        public async void Start()
        {
            try
            {
                ...
                _connection.On<string>("RateChanged", (dataInJson) =>
                {
                    ...
                    var newMessage = $"SignalR: RateChanged - {dataInJson}";
...
//                    var newMessage = $"SignalR: TheSameRate - {dataInJson}";
//                    _logFile.AppendLine(newMessage);
                });
